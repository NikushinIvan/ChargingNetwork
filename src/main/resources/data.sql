...
('testtmu', '$2a$12$kVYEwGq2Edi2X3A4qhUgp.ZjX2jITU7LIei/JSuCyT0OtF7bMyaUK', NULL, 'Ирина', 'Говорова', NULL),
('testtms', '$2a$12$6hzHFn8BE7jpAeTSSS8Cj..C9aUCoSSN5cwtRk8HhXJ1ZpaE7XKVC', NULL, 'Павел', 'Быков', NULL),
...
INSERT INTO Stations (station_name, login, password, manager_id, vendior_id, address_id, station_state)
